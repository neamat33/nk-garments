...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Update Knitting </h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('knitting.update',$single->id) }}">
                @csrf
                @method('PUT')
                <div class="card">
                    <div class="card-body">
                            ...
                            <table class="table table-responsive-md mytable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="weight" id="weight" placeholder="Pcs"  value="{{ $single->weight }}"  class="form-control form-control-sm cone">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
