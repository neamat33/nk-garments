...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Create Production Receive </h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('production_receive.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <table class="table table-responsive-md mytable">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 20%"><strong>Dozen</strong></th>
...
@section('extra_js')
   ...
   @include('admin.production.production_receive.scripts')
