                                ...
                                <div class="form row">
                                        <div class="form-group col-md-5">
                                            <input type="text" name="start_date" data-provide="datepicker"
                                                ...
                                                data-date-format="yyyy-mm-dd" data-date-autoclose="true" class="form-control datepicker"
                                    ...
                                    <table class="table table-responsive">
                                        ...
                                        <tbody>
                                            @foreach ($send_items as $key => $item)
                                                <tr>
                                                    <td><strong>{{ isset($_GET['page']) ? ($_GET['page'] - 1) * $knittings->count() + $key + 1 : $key + 1 }}</strong>
                                                    </td>
                                                    <td>{{ $item->item_name }}</td>
                                                    <td>{{ $item->total_qty }} Kg</td>
                                                    <td>{{ $item->total_cone }} Pcs</td>
                                                </tr>
                                            @endforeach
