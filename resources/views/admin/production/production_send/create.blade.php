...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Create Production Send </h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('production_send.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <select name="department_to" id="" class="form-control form-control-sm" required>
                                    @foreach($departments as $dep)
                                        <option @if($dep->id == 4) selected @endif value="{{$dep->id}}">{{$dep->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            <label class="col-sm-4 col-form-label">Department Head<span class="text-danger">*</span> :</label>
                            <div class="col-sm-8">
                                <select name="employee_id" id="" class="form-control form-control-sm" required>
                                    @foreach($employee as $emp)
                                        <option @if($emp->id == 4) selected @endif value="{{$emp->id}}">{{$emp->employee_name}}</option>
                                    @endforeach
                                </select>
                            ...
                            <table class="table table-responsive-md mytable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" name="weight[]" id="weight" placeholder="Kg" class="form-control form-control-sm cone">
                                        </td>
...
@section('extra_js')
   ...
   @include('admin.production.production_send.scripts')
