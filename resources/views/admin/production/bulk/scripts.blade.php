<script>
    $(document).ready(function () {
        ...
        $('#addrow').on('click', function () {
            ...
            cols += '<td><input type="text" name="stock[]" id="stock" class="form-control form-control-sm stock" readonly></td>';

            cols += '<td><input type="number" name="qty[]" class="form-control form-control-sm qty"></td>';
            cols += '<td><input type="number" name="cone[]" class="form-control form-control-sm cone"></td>';
        ...
        $(".mytable").on("change", '.item-select', function () {
            ...
            var stock_qty = selectedOption.data('qty');
            var cone_qty = selectedOption.data('cone');
            ...
            stockField.val('qty: '+ stock_qty +' cone: '+ cone_qty);
