...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3 pl-3">
            ...
            <a href="{{ route('cutting.index')}}" class="btn btn-sm btn-info">Cutting List </a>
        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                               <input type="text" class="form-control form-control-sm" value="# {{ $cutting->id}}" readonly>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                               <input type="text" class="form-control form-control-sm" value="{{ $cutting->department->name}}" readonly>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <textarea name="note" id="" class="form-control" readonly>{{ $cutting->note }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <div id="datepicker2" class="input-group date" data-date-format="yyyy-mm-dd">
                                    <input class="form-control form-control-sm" value="{{ date('d-m-Y',strtotime($cutting->date)) }}" type="text" readonly
                            ...
                            <table class="table table-bordered table-striped table-responsive-md">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$raw_item->qty}} Pcs</td>
                                        <td>{{$raw_item->weight}} Kg</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-striped table-responsive-md">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>@if($item->item_variation_id!=null)
