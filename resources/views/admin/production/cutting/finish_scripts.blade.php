<script>
    $(document).ready(function () {
        ...
        $('#addrow1').on('click', function () {
            ...
            cols += '<td><input type="number" name="weight[]" class="form-control form-control-sm weight"></td>';
        ...
        $(".mytable1").on("keyup", 'input[class*="rate"], input[class*="main_unit_qty"], input[class*="sub_unit_qty"]', function (event) {
