<script>
    $(document).ready(function () {
        ...
        $('#addrow').on('click', function () {
            ...
            cols += '<td><select name="send_item[]" class="select1 item-select">\n\
            ...
            cols += '<td><input type="number" name="send_dozen[]" class="form-control form-control-sm send_dozen"></td>';
            cols += '<td><input type="number" name="send_qty[]" class="form-control form-control-sm send_qty"></td>';
            cols += '<td><input type="number" name="send_weight[]" class="form-control form-control-sm weight"></td>';
