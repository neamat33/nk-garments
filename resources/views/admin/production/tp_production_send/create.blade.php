...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Send Third Party Production</h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('tp_production_send.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-8">
                                <select name="department_id" id="" class="form-control form-control-sm" required>
                                    @foreach($departments as $dep)
                                        <option @if($department_id == $dep->id) selected @endif value="{{$dep->id}}">{{$dep->name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            <label class="col-sm-4 col-form-label">Party Name<span class="text-danger">*</span> :</label>
                            <div class="col-sm-8">
                                <select name="party_id" id="party_id" class="form-control form-control-sm select2" required>
                                    <option value="" > Select Party..</option>
                                    @foreach($parties as $party)
                                        <option value="{{$party->id}}" data-address="{{ $party->company_address}}">{{$party->party_name}}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            <label class="col-sm-4 col-form-label">Delivery to :</label>
                            <div class="col-sm-8">
                                <textarea name="company_address" id="company_address" class="form-control" readonly></textarea>
                ...
                <div class="card mt-2">
                    <div class="card-header pt-3 pb-3">
                        <h5><span class="fa-solid fa-qrcode"></span> SEND ITEMS</h5>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-responsive-md mytable">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <select name="send_item[]" class="item-select select2">
                                        ...
                                        <td>
                                            <input type="text" name="send_stock[]" id="send_stock" class="form-control form-control-sm stock" readonly>
                                        </td>

                                        <td>
                                            <input type="number" name="send_dozen[]" id="send_dozen" placeholder="Pcs" class="form-control form-control-sm raw_dozen">
                                        </td>
                                        <td>
                                            <input type="number" name="send_qty[]" id="send_qty" placeholder="Pcs" class="form-control form-control-sm qty">
                                        </td>

                                        <td>
                                            <input type="number" name="send_weight[]" id="send_weight" placeholder="Kg" class="form-control form-control-sm raw_weight">
                                        </td>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header pt-3 pb-3">
                            <h5><span class="fa-solid fa-qrcode"></span> EXPECTED OUTPUT ITEMS</h5>
                        </div>
                        <div class="card-body">
...
@section('extra_js')
   ...
   @include('admin.production.tp_production_send.send_scripts')
   @include('admin.production.tp_production_send.scripts')
