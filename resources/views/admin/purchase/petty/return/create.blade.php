...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Petty Purchase Return</h4>
        </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control form-control-sm" type="text" value="{{ $petty_purchase->id }}" readonly name="purchase_id" />
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-responsive-md mytable">
                                ...
                                <tbody>
                                    @foreach ($petty_purchase->items as $key => $item )
                                ...
                                <tfoot>
                                    ...
                                    <tr class="">
                                        ...
                                        <th class="text-center" id="total_qty">Total Qty: {{ $petty_purchase->items->sum('due_qty') }}</th>
                                        <th></th>
                                        <th class="text-center" id="totalsubtotal">S. Total: {{ $petty_purchase->items->sum('sub_total') }}</th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
...
@section('extra_js')
    ...
    @include('admin.purchase.petty.return.script')
