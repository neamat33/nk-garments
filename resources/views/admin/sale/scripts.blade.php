<script>
    $(document).ready(function () {
        ...
        $('#addrow').on('click', function () {
            ...
            cols += '<td><input type="text" id="stock" class="form-control form-control-sm stock" readonly></td>'
            ...
            cols += '<td><input type="number" name="commission[]" id="commission" class="form-control form-control-sm commission"></td>'
        ...
        function updateVariationDropdown(variations) {
            ...
            variations.forEach(function (variation) {
                ...
                var variationName = 'S: ' + size + ' - ' + color + ' (' + stock + ')';
        ...
        function calculateRow(row) {
            ...
            var sub_unit_qty = +row.find('input[class*="sub_unit_qty"]').val() / related_unit || 0;
