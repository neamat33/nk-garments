    ...
    <div class="container-fluid">
        <div class="card mt-3">
            <div class="card-header">
                <h3><strong>Party Sale Invoice</strong></h3>
                    ...
                    <div class="row mb-5">
                        <div class="mt-4 col-xl-6 col-lg-6 col-md-6 col-sm-6">
                            <div class="party_info">
                                <div class="name"><strong>Invoice No: {{$party_sale->id}}</strong></div>
                                <div class="name"><strong>Party Name: {{$party_sale->party->party_name}}</strong></div>
                                <div class="phone_no"><strong>Phone Number: {{$party_sale->party->phone}}</strong></div>
                                <div class="showroom"><strong>Showroom: {{$party_sale->showroom}}</strong></div>
                                <div class="sale_date"><strong>Sale Date: {{date('d M, Y', strtotime($party_sale->sale_date))}}</strong></div>
                                <div class="delivery_date"><strong>Delivery Date: {{date('d M, Y', strtotime($party_sale->delivery_date))}}</strong></div>
                            </div>
                        </div>
                        ...
                        <table class="table table-clear">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="right">BDT {{ number_format($party_sale->total_discount,2) }}</td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="right">BDT {{ number_format($party_sale->paid,2) }}</td>
                                </tr>
                                <tr>
                                    <td class="left"><strong>Due :</strong></td>
                                    <td class="right">BDT {{ number_format($party_sale->due,2) }}</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
