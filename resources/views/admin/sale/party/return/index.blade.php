    ...
    <div class="container-fluid">
        ...
        <div class="card print" id="print-area">
            <div class="card-header">
                <h4 class="card-title">Party Sales Return List</h4>
            </div>
            <div class="row">
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive-md">
                            ...
                            <tbody>
                                ...
                                <tr>
                                   <td><strong>{{$sale_return->party_sale_id}}</strong></td>
                                   <td>{{$sale_return->party_sale_id}}</td>
                                   <td>{{$sale_return->party->party_name}}</td>
                                   ...
                                   <td class="print_hidden">
                                       <div class="btn-group" role="group">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target=".delete-modal" onclick="handle({{$sale_return->id}})"><i class="fas fa-trash"></i> Delete</a>
                                                @endcan
                                            </div>
                                        </div>
                                   </td>
...
<script>
    //Delete Code
    function handle(id) {
       var url = "{{ route('party-sale-return.destroy', 'sale_id') }}".replace('sale_id', id);
