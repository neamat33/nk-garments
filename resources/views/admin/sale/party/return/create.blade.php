...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Return Party Sale</h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('party-sale-return.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control form-control-sm" type="text" value="{{ $party_sale->total_commission }}" name="return_commission" />
                            </div>
                        </div>
                    </div>
                     <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input class="form-control form-control-sm" type="text" value="{{ $party_sale->total_discount }}" name="return_discount" />
                            </div>
                        </div>
                    </div>
                    <div class="col-6">
                            ...
                            <table class="table table-responsive-md mytable">
                                ...
                                <tfoot>
                                    ...
                                    <tr class="">
                                        ...
                                        <th></th>
                                        {{-- <th class="text-center" id="total_commission" colspan="">Total C: {{ $party_sale->items->sum('commission') }}</th> --}}
                                        <th class="text-center" id="totalsubtotal">S. Total: {{ $party_sale->items->sum('sub_total') }}</th>
                                        <th></th>
                                    </tr>
                                </tfoot>
                            </table>
...
@section('extra_js')
    ...
    @include('admin.sale.party.return.script')
