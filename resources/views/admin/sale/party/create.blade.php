...
<div class="content-body" style="min-height: 500px">
    <div class="container-fluid">
        <div class="card-header mb-3">
            <h4 class="card-title">Create Party Sale</h4>
        </div>
        <div class="basic-form">
            <form method="POST" action="{{ route('party-sale.store') }}">
                @csrf
                <div class="row">
                    <div class="col-6">
                        <div class="mb-3 row">
                    ...
                    <div class="col-6">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <select name="sale_type" id="" class="form-control form-control-sm">
                                    <option value="">Select Sale Type</option>
                                    <option value="Party Sales(Regular Item)">Party Sales(Regular Item)</option>
                                </select>
                                @if($errors->has('sale_type'))
                                    <span class="invalid-feedback">{{ $errors->first('sale_type') }}</span>
                                @endif
                            </div>
                        </div>
                    </div>
